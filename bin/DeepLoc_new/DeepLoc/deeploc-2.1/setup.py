...
setuptools.setup(
    name="DeepLoc2",
    version="1.0.0",
    author="Marius Thrane Oedum",
    author_email="mtoedum@gmail.com",
    description="Prediction of subcellular localization and membrane protein types",
    #scripts=['bin/deeploc2'],
    entry_points={'console_scripts':['deeploc2=DeepLoc2.deeploc2:predict']},
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://services.healthtech.dtu.dk/service.php?DeepLoc-2.1",
    project_urls={
        "Bug Tracker": "https://services.healthtech.dtu.dk/service.php?DeepLoc-2.1",
    },
